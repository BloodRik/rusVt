...
export default function FonColorDarkLight() {
  
  return (
    <>
    <div className="switch m-[-14.5px] ml-[-5px]">
    ...
    {/* <svg
              ...
              className="absolute left-[4px] top-[5px] rounded-[20px] w-[25px] h-[25px] bg-white"
            >
              <path
      ...
      {/* <button type="button" role="switch" aria-checked="false" className="">
        <span className="">
          <span className="">
            <svg
              width="16px"
